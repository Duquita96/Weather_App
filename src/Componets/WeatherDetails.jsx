...
const weatherCase = ["Partly cloudy", "Sunny", "Cloudy", "Rainy", "Overcast", "Light snow, mist", "Clear", "Mist", "Fog", "Haze"];

const bGAddress =["Partlycloudy.gif", 
"Sunny.gif", "Cloudy.gif", "Rainy.gif", 
"Overcast.gif", "Lightsnowmist.gif", "Clear.gif", 
"Mist.gif", "Fog.gif", "Haze.gif", "extra.gif"]
